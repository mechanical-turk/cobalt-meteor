...
function init(config) {
  return function(options) {
    ...
    function installMeteorDeps() {
      ...
      execSync('meteor add stylus react-meteor-data twbs:bootstrap aldeed:simple-schema aldeed:collection2 aldeed:autoform aldeed:delete-button momentjs:moment natestrauser:font-awesome kadira:flow-router ian:accounts-ui-bootstrap-3 accounts-password', {cwd: projectPath});
